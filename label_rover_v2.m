function post_align_struct = label_rover_v2(post_align_struct, rover_stack)
...
elseif post_align_struct.year == 2023
    post_align_struct.l_gait.DateTime.Year = 2023;
else
    post_align_struct.l_gait.DateTime.Year = 2024;
end
...
elseif post_align_struct.year == 2023
    ...
    post_align_struct.r_gait.DateTime.Year = 2024;
end
...
rover_stack_left.Year = year(rover_stack_left.Time);
rover_stack_left = rover_stack_left(rover_stack_left.Year == post_align_struct.year,:);
rover_stack_right.Year = year(rover_stack_right.Time);
rover_stack_right = rover_stack_right(rover_stack_right.Year == post_align_struct.year,:);
...
for i = 1:size(rover_stack_left,1)
    if (rover_stack_left.Time(i) < post_align_struct.l_gait.DateTime(1) & rover_stack_left.End(i) < post_align_struct.l_gait.DateTime(1)) || (rover_stack_left.Time(i) > post_align_struct.l_gait.DateTime(end) & rover_stack_left.End(i) > post_align_struct.l_gait.DateTime(end))      
        update = [num2str(100*i/size(rover_stack_left,1)) '% done with left'];
        disp(update)
    else
...
for i = 1:size(rover_stack_right,1)
    if (rover_stack_right.Time(i) < post_align_struct.r_gait.DateTime(1) & rover_stack_right.End(i) < post_align_struct.r_gait.DateTime(1)) || (rover_stack_right.Time(i) > post_align_struct.r_gait.DateTime(end) & rover_stack_right.End(i) > post_align_struct.r_gait.DateTime(end))      
        update = [num2str(100*i/size(rover_stack_right,1)) '% done with right'];
        disp(update)
    else
