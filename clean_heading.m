...
output_struct.l_gait.Heading_Interp = heading_interp;
output_struct.l_gait.Heading_Smooth = heading_smooth;
output_struct.coeff_smooth = coeff_smooth;
output_struct.zero_interv = zero_interv;
output_struct.smooth_interv = smooth_interv;
output_struct.delay = delay;
