...
if contains(subject,'RCS_01')
    path = '/Volumes/dwang3_shared/Patient Data/RC+S Data/gait_RCS_01/Rover/Rover Excel Reports';
end
...
if contains(subject,'RCS_03')
    path = '/Volumes/dwang3_shared/Patient Data/RC+S Data/gait_RCS_03/Rover/Rover Excel reports';
end
